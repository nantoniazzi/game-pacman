    ...
    if (tooltip) {
      ...
      if (showing.length) {
        ...
        for (let show of showing) {
          ...
          if (state !== null) {
            let tooltipBlock = 'px: ' + Math.round(point.x) + ', py: ' + Math.round(point.y);
            const params = module.currentFrame.registered[show];




            //            if (String(params.Type).valueOf() == "Item") {
            //              tooltipBlock =
            //                params.Name
            //                + '\nCost ' + params.Price
            //                ;
            //              for (let key in params) {
            //                if (key != "Type" && key != "Price" && key != "Name" && key != "maxMana" && key != "maxHealth")
            //                  tooltipBlock += '\n' + key + ' ' + params[key];
            //              }
            //            } else { // units only
            //              tooltipBlock =
        ...
        tooltip.label.text = 'px: ' + Math.round(point.x) + ', py: ' + Math.round(point.y);
